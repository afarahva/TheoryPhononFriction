...
path1   = "../calc_memory/results/CO_Fe_EAM_bcc110_cell=4x4x4/w=%scm-1.npz"%(100)
path2   = "../calc_memory/results/CO_Fe_EAM_bcc110_cell=4x4x4/w=%scm-1.npz"%(300)
path3   = "../calc_memory/results/CO_Fe_EAM_bcc110_cell=4x4x4/w=%scm-1.npz"%(500)
...
axs[0][2].set_title(r"$\omega_{as} = 500$ cm$^{-1}$",fontsize=26,y=1.05)

fig.tight_layout()
plt.savefig("./figureS3/figureS3.pdf",bbox_inches="tight")
plt.show()
