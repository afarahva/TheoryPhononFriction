...
path3   = "../calc_memory/results/CO_Pt_EMT_fcc111_cell=4x4x8/w=%scm-1.npz"%(600)
...
path1   = "../calc_memory/results/CO_Pt_LJ_fcc111_cell=4x4x8/w=%scm-1.npz"%(100)
path2   = "../calc_memory/results/CO_Pt_LJ_fcc111_cell=4x4x8/w=%scm-1.npz"%(300)
path3   = "../calc_memory/results/CO_Pt_LJ_fcc111_cell=4x4x8/w=%scm-1.npz"%(600)
paths = [path1,path2,path3]
...
fig.tight_layout()
plt.savefig("./figureS1/figureS1.pdf",bbox_inches="tight")
plt.show()
